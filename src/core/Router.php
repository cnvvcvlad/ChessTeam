...
use Democvidev\ChessTeam\Controller\FormController;
        ...
        try {
            ...
            if (isset($_GET['action'])) {
                ...
                if ($action == 'inscription') {
                    ...
                    require $this->path . '/../src/controller/FormController.php';
                    ...
                    if (isset($_GET['modifyC'])) {
                        $modifyComment = $comment->getComment(
