...
try {
    ...
    if (isset($_POST['connexion'])) {
        ...
        $update_m = $manager_user->updateMembre(
            $id_user,
            new Users([
                'login' => $login,
                'email' => $email,
        ...
        $manager_category->updateCategory(
            $id,
            new Category([
                'title' => $title,
