...
<?php if (!empty($params['post'])): ?>
    <?php foreach ($params['post'] as $key => $value): ?>
        ...
        <div id="detail_art" class="justify_article">
                ...
                <img src="<?= SCRIPTS . 'img' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . $value->getArt_image() ?>" alt="Image de l'article">
        ...
        <div class="comment-block">
            ...
            <h3 class="comment-libelle">(<?= isset($params['commentsOfArticle']) ? count(
                $params['commentsOfArticle']
            ) : '' ?>) Commentaire<?= count($params['commentsOfArticle']) == 1 ? '' : 's' ?></h3>
            ...
            <?php endif; ?>
            <div class="back-page">
                <a href="<?= dirname(SCRIPTS) ?>/posts">Retour en arrière</a>
