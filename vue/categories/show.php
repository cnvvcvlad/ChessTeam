        ...
        <?php if (!empty($params['category'])): ?>
            <?php foreach ($params['category'] as $key => $value): ?>
                ...
                <div class="justify_article">
                    ...
                    <img src="<?= SCRIPTS . 'img' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . $value->getCategory_image() ?>" alt="Image de la catégorie" title="Cliquez pour agrandir"></a>
...
<?php endif; ?>
        <div class="back-page">
            ...
            <a href="<?= dirname(SCRIPTS) . DIRECTORY_SEPARATOR . 'category' . DIRECTORY_SEPARATOR . $value->getId() . DIRECTORY_SEPARATOR . 'posts' ?>" class="bouton_rouge">Consulter
