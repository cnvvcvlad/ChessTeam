                        ...
                        <?php if (!empty($lastArticle_one)) : ?>
                            <?php foreach ($lastArticle_one as $key => $value) : ?>
                                ...
                                <p>Ecrit par
                                    ...
                                    <strong><?= showNameCategory($value->getCategory_id()) ?></strong>
                                </p>
                    ...
                    <ul class="menu">
                        ...
                        <li class="item" id="message">
                            ...
                            <div class="smenu">
                                ...
                                <a href="?action=rss" rel="noreferrer noopener" target="_blank">Flux RSS<img src="assets/img/logo/rss.png" alt="Le Flux RSS" title="Flux RSS" /></a>
                            </div>
                        </li>
    ...
    <script>
        if (document.getElementById('recaptchaResponse')) {
            grecaptcha.ready(function() {
                grecaptcha.execute('6LcgZ-oUAAAAAKdW6gHFYFBm7Qx-d52XntvALZma', {
                    action: 'homepage'
                }).then(function(token) {
