/* PrismJS 1.27.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+c+csharp+cpp+docker+git+graphql+javadoclike+jsdoc+json+json5+jsonp+markdown+markup-templating+mongodb+php+phpdoc+powershell+python+jsx+tsx+regex+scss+sql+twig+typescript+yaml */
